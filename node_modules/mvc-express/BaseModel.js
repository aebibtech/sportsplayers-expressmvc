...
class BaseModel{
    ...
    query(query, parameters = null) {
        ...
        this.lastExecutedQuery = this.connection.format(query, parameters);
        const lastExecutedQuery = this.lastExecutedQuery;
        return new Promise(function(resolve, reject){
            connLoc.query(lastExecutedQuery, function(err, result){
                try{
                    resolve(result);
                }catch(e){
                    reject(err);
